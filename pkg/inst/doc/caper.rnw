...
\title{The \textit{caper} package: comparative analysis of phylogenetics and evolution in R}
\author{David Orme}
...
This vignette documents the use of the \textit{caper} package for R \citep{R-Development-Core-Team.2008.a} in carrying out a range of comparative analysis methods for phylogenetic data. 
